...
function FeaturedItineraries() {
  ...
  useEffect(() => {
    const fetchItineraries = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/guest/itineraries/viewItineraries");
...
function FeaturedHistoricalPlaces() {
  ...
  useEffect(() => {
    const fetchHistoricalPlaces = async () => {
      try {
        const response = await axios.get("http://localhost:5000/api/guest/historicalPlaces/getHistoricalPlaces");
