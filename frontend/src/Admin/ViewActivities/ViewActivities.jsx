...
const fetchSortedActivities = async (sortOrder) => {
  try {
    ...
    const response = await axiosInstance.get('http://localhost:5000/api/admin/admin/viewActivitiesAdmin', {
      params: params,
    });
...
export default ViewActivitiesAdmin;
